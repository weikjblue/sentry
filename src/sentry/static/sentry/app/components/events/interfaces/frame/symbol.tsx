...
const Symbol = ({
  ...
  const wrapperID = frameID ? `frame-${frameID}` : undefined;
    ...
    <Wrapper id={wrapperID}>
      ...
      >
        <FunctionNameToggleIcon
          ...
          onClick={
            hasFunctionNameHiddenDetails && wrapperID
              ? onFunctionNameToggle(wrapperID)
              : undefined
          }
          size="xs"
          color="purple400"
      ...
      <Data>
        ...
        {frame.filename && (
          <Tooltip title={frame.absPath} disabled={!enablePathTooltip}>
            <Filename>
              {'('}
              {frame.filename}
